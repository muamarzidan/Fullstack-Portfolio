            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl font-bold text-blue-400 dark:text-blue-300 mb-4">Portfolio</h3>
                        <p className="text-gray-300 dark:text-gray-400 mb-4 max-w-md">
                            Fullstack Developer specializing in modern web technologies. 
                            Building innovative solutions with Next.js, PostgreSQL, and cutting-edge tools.
                        </p>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <button
                                    ...
                                    className="text-gray-300 dark:text-gray-400 hover:text-blue-400 dark:hover:text-blue-300 transition-colors cursor-pointer"
                                >
                                    Home
                                </button>
                            </li>
